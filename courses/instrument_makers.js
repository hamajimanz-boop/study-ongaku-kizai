      ...
      sections: [
        {
          heading: "会社の正体・沿革",
          paragraphs: [
            "1946年、アメリカ・カリフォルニア州フラトンでLeo Fenderが設立。Leo自身はラジオ・アンプの修理業出身の技術者で、実は生涯ほとんどギターを弾けなかったとされる。「演奏者ではなく製造者・修理のしやすさの視点」で楽器を設計したことが、後の量産成功の一因になった。",
            "1950年発売のTelecaster(発売時はEsquire→Broadcaster→Telecasterと改称)は、世界初の量産型ソリッドボディ・エレキギター。1951年にはPrecision Bass(通称P-Bass)を発売し、これも世界初の量産型エレキベースとなった。1954年のStratocasterで、現在まで続くエレキギターの基本フォーマットがほぼ完成した。",
            "1965年にCBS(コロンビア放送)に売却され、いわゆる「CBS期」は量産重視で品質低下が指摘されることもあった。1985年に経営陣・投資家グループが買い戻し、現在のFender Musical Instruments Corporation(FMIC)として独立。",
          ],
        },
        {
          heading: "音の特徴",
          paragraphs: [
            "シングルコイル・ピックアップ(コイルが1つの構造)による、明るく硬質でクリアな「テリー(Telecaster的なきらびやかさ)」「ストラトのくすんだクセ(スコンとした音)」が特徴。ハムバッカー式のGibson系と対比される音の基準として語られる。",
            "ボルトオン・ネック(ネックをボディにネジ留めする構造)を採用しており、Gibson系のセットネック(接着)よりアタック感が強く出るとされる。製造コスト・修理のしやすさの面でも優れており、量産向きの設計思想が音のキャラクターにも表れている。",
          ],
        },
        {
          heading: "代表製品ラインナップ",
        ...
        },
        {
          heading: "お金の話",
          paragraphs: [
            "2012年に株式上場を計画していたが、直前で撤回した経緯がある。ギター人口の減少懸念など市場の不確実性が背景にあったとされる。現在は非公開企業として運営を続けている。",
            "傘下にはSquier(廉価版ブランド)のほか、Jackson、Charvel、EVH、Gretsch(一部ライセンス生産)なども持ち、単一ブランドではなく複数価格帯・複数キャラクターのブランド群を統括するグループとして事業を展開している。",
          ],
        },
        {
          heading: "業界内でのポジション",
          ...
          paragraphs: [
            "最大のライバルはGibson。「ボルトオン・シングルコイルで明るいFender」対「セットネック・ハムバッカーで太いGibson」という対比は、エレキギターの歴史そのものを貫く二大潮流として語られる。近年はPRSが両者の中間的な性格のブランドとして第三勢力の地位を固めつつある。",
          ],
        },
        {
          heading: "豆知識",
          paragraphs: [
            "Telecasterの最初期の名称「Broadcaster」は、ドラムメーカーGretschの商標「BroadKaster」と衝突したため短期間で改称された経緯がある。この移行期の無銘(ロゴ無し)モデルは「Nocaster」と呼ばれ、コレクターの間で特に珍重されている。",
          ],
        },
      ],
      quiz: [
    ...
    },
    {
      ...
      sections: [
        ...
        },
        {
          heading: "音の特徴",
          paragraphs: [
            "ハムバッカー・ピックアップ(コイルを2つ組み合わせノイズを打ち消す構造)による、太く滑らかで歪ませても潰れにくい音が特徴。セットネック(接着)構造による長いサステイン(音の伸び)も評価される。",
            "マホガニーボディにメイプル(楓)の甲板を貼り合わせる構造(Les Paul)は、低域の量感と高域の煌びやかさを両立する組み合わせとして広く模倣されている。",
          ],
        },
        {
          heading: "代表製品ラインナップ",
        ...
        },
        {
          heading: "お金の話",
          paragraphs: [
            "2018年の経営破綻は、ギター事業自体よりもオーディオ機器メーカーPhilips傘下のブランド買収など、本業から離れた多角化投資が主因とされている。再建後はギター/ベース本業への集中と、Epiphoneなど廉価ブランドの強化が進められている。",
          ],
        },
        {
          heading: "業界内でのポジション",
          paragraphs: [
            "Fenderとの「ボルトオン明るい系」対「セットネック太い系」という対比が最大の軸。近年はPRSが両者の中間的キャラクターで存在感を増しており、御三家的な構図が語られることもある。",
          ],
        },
        {
          heading: "豆知識",
          paragraphs: [
            "Les Paul本人はロイヤリティ契約に基づき自身の名を冠したモデルの売上から収入を得ており、後年「自分の名前がついた楽器で最も多くの富を得たミュージシャン」とも評された。",
          ],
        },
      ],
      quiz: [
      ...
      sections: [
        {
          heading: "会社の正体・沿革",
          paragraphs: [
            "日本の星野楽器(Hoshino Gakki、1908年創業)が展開するギターブランド。「Ibanez」の名は、かつて星野楽器が輸入していたスペインのギター製作者Salvador Ibáñezの名に由来する。",
            "1970年代、GibsonやFenderの人気モデルに酷似した「コピーモデル」を製造・輸出していたことが問題となり、1977年にGibson側と訴訟・和解(いわゆる「訴訟時代」)。これを機にオリジナルデザインへの転換を進め、後のRGシリーズなど独自路線を確立した。",
            "1980年代後半以降、Steve Vai(JEMシリーズ、ネックの「モンキーグリップ」穴やライオンズクロウ形のトレモロ彫り込みが特徴)、Joe Satriani(JSシリーズ)ら著名ギタリストとのシグネチャーモデル展開で「テクニカル系ギタリストのブランド」としての地位を確立した。",
          ],
        },
        {
          heading: "音の特徴",
          paragraphs: [
            "高出力ハムバッカーによる歪ませた時の抜けの良さ、そして極薄・高速なネック形状(Wizardネック等)による速弾きのしやすさが特徴。7弦/8弦などの拡張弦モデルにも早くから注力し、低チューニングのヘヴィな音楽ジャンルでも定番化した。",
            "フロイドローズ式トレモロ(アーミングしても音程が狂いにくいブリッジ機構)の搭載モデルが多く、激しいアーミング奏法を安定して行える点もメタル/シュレッド系ギタリストに支持される理由。",
          ],
        },
        {
          heading: "代表製品ラインナップ",
        ...
        },
        {
          heading: "お金の話",
          paragraphs: [
            "自社工場「富士弦楽器製造(Fujigen)」との長年の関係により、日本製の高い製造品質と量産効率を両立してきた。近年は上位モデルをインドネシア・中国等の工場にも展開しつつ、Premiumライン以上は日本製にこだわるなど価格帯ごとの生産国戦略を取っている。",
          ],
        },
        {
          heading: "業界内でのポジション",
          paragraphs: [
            "Jackson、Charvel、ESPといった「速弾き/メタル向け」ブランドと直接競合する。Fender/Gibsonの「伝統」路線とは異なる「性能・演奏性重視」の市場を切り開いたパイオニア的存在とされる。",
          ],
        },
        {
          heading: "豆知識",
          paragraphs: [
            "Steve VaiのJEMシリーズに開けられた「モンキーグリップ」(ネック近くのボディに開いた持ち手用の穴)は、当初「重量削減」との説明もあったが、実際にはステージ上でギターを片手で持ち上げるパフォーマンス用の意匠という説が有力。",
          ],
        },
      ],
      quiz: [
      ...
      sections: [
        {
          heading: "会社の正体・沿革",
          paragraphs: [
            "1985年、アメリカ・メリーランド州でPaul Reed Smith本人が設立。大学時代からギター製作を独学で始め、有名ミュージシャンに直接ギターを見せて回るなど、地道な営業活動からブランドを立ち上げた経緯を持つ。",
            "創業初期にCarlos Santanaが同社のギターを気に入り使用を始めたことが、ブランドの信頼性を大きく押し上げたとされる。GibsonでLes Paul開発時代の社長を務めたTed McCarty氏を顧問に迎え、その名を冠したMcCartyシリーズも展開している。",
          ],
        },
        {
          heading: "音の特徴",
          paragraphs: [
            "「Fenderの弾きやすさ・レスポンスの速さ」と「Gibsonの太さ・サステイン」を両立させることを明確な設計目標に掲げてきたブランド。多くのモデルがセットネック構造ながら、Fender的な機敏さを感じさせるネックシェイプを追求している点が特徴。",
            "24フレット仕様や独自のトレモロブリッジ設計など、Fender/Gibsonのどちらの伝統にも属さない独自のディテールを多く持つ。",
          ],
        },
        {
          heading: "代表製品ラインナップ",
        ...
        },
        {
          heading: "お金の話",
          paragraphs: [
            "木材の杢目(もくめ、木目の美しさ)の等級によって価格が変わる「10 Top」というグレーディング制度が有名で、見た目の美しさそのものが価格の付加価値として明確に商品化されている。基準に満たない木材は容赦なく製品から外されるという、徹底した品質管理でも知られる。",
          ],
        },
        {
          heading: "業界内でのポジション",
          paragraphs: [
            "Fender・Gibsonの「二大老舗」に次ぐ「第三勢力」として、ハイエンド市場での存在感を確立した数少ない後発ブランドの一つ。ボディインレイに使われる鳥のデザイン(バードインレイ)は同社の視覚的な識別要素として広く認知されている。",
          ],
        },
        {
          heading: "豆知識",
          paragraphs: [
            "フレットボードに施されるバード(鳥)インレイは、モデルグレードによってデザインが異なり、コレクターの間ではグレード識別の目安としても使われている。",
          ],
        },
      ],
      quiz: [
      ...
      sections: [
        {
          heading: "会社の正体・沿革",
          paragraphs: [
            "1931年、Adolph RickenbackerとGeorge Beauchampらによって設立(当時の社名はRo-Pat-In)。同年発表の「フライパン」(Frying Pan、ラップスティール型の電気楽器)は、世界初期の電気楽器の一つとされる。",
            "1950年代後半以降のセミホロウボディ「300シリーズ」(330/360等)が看板製品となり、1960年代にThe Beatles(George Harrisonの360/12、12弦モデル)やThe Byrds(Roger McGuinn)が使用したことで「ジャングリー(きらびやかに揺れる)サウンド」の代名詞となった。",
            "ベースの4001/4003シリーズも、Paul McCartney(The Beatles)、Chris Squire(Yes)ら著名ベーシストが使用し、ロック/プログレの音を象徴する存在になった。",
          ],
        },
        {
          heading: "音の特徴",
          paragraphs: [
            "12弦モデルの「ジャングルサウンド」(倍音の多い、シャリシャリと煌めくコーラス的な響き)が最大の個性。ベースにおいては、「ホースシュー・ピックアップ(馬蹄形の磁石を持つ独自形状)」による中域の強い「グロウル(唸るような)」サウンドが特徴で、通常のベースとは明確に異なる音の輪郭を持つ。",
            "「Rick-O-Sound」というステレオ出力機構(ピックアップごとに別々の出力に振り分けられる)も同社独自の仕様として知られる。",
          ],
        },
        {
          heading: "代表製品ラインナップ",
        ...
        },
        {
          heading: "お金の話",
          paragraphs: [
            "同族経営(Hall家)を維持する非公開企業で、海外への正規販売網を意図的に限定するなど、供給量を絞ることでブランドの希少性を保つ戦略を取っているとされる。他社に比べエンドースメント契約(有名奏者への提供契約)にも消極的であることで知られる。",
          ],
        },
        {
          heading: "業界内でのポジション",
          paragraphs: [
            "Fender/Gibsonのような「主流」の座を追わず、独自のニッチ(ジャングルサウンド、プログレ/オルタナティブ系のベース)に特化したポジションを保ち続けている数少ないヴィンテージブランド。",
          ],
        },
        {
          heading: "豆知識",
          paragraphs: [
            "中古市場での流通量が絞られていることもあり、状態の良いヴィンテージモデルは他ブランド以上に価格が高騰しやすい傾向がある。",
          ],
        },
      ],
      quiz: [
      ...
      sections: [
        {
          heading: "会社の正体・沿革",
          paragraphs: [
            "1975年、日本で創業(Electric Sound Products)。当初はパーツ/リペア事業から始まり、後にオリジナルブランドとして展開。カスタムショップ(ESP)と、より手頃な海外生産ライン(LTD)の二段構えで展開している。",
            "Metallicaのギタリスト James Hetfield・Kirk Hammettや、多くのエクストリームメタル系アーティストとのシグネチャーモデル契約で知られる。",
          ],
        },
        {
          heading: "音の特徴",
        ...
        },
        {
          heading: "お金の話",
          paragraphs: [
            "ハイエンドのESPカスタムショップ製品と、量産型のLTDブランドで価格帯を分けることで、プロ向けとアマチュア向け両方の市場を同時に取り込むビジネスモデルを確立している。",
          ],
        },
        {
          heading: "業界内でのポジション",
          paragraphs: [
            "Jackson、Schecterと並ぶメタル系ブランドの代表格。特にエクストリームメタル/デスメタル系のアーティストからの支持が厚い点が特徴。",
          ],
        },
        {
          heading: "豆知識",
          paragraphs: [
            "James HetfieldとKirk Hammettという同一バンド(Metallica)の2人のギタリスト双方とシグネチャー契約を結んでいる点は、1ブランドが1バンドを事実上独占しているような珍しい事例として語られる。",
          ],
        },
      ],
      quiz: [
      ...
      sections: [
        {
          heading: "会社の正体・沿革",
          paragraphs: [
            "1976年、アメリカでSchecter Guitar Researchとして創業。当初はFender系ギターの交換用パーツ(ネック、ボディ等)を製造する部品メーカーとしてスタートし、後に完成品ギターブランドへと発展した。",
          ],
        },
        {
          heading: "音の特徴",
          paragraphs: [
            "ミドルクラス〜ハイエンドの価格帯で、メタル/ハードロック向けの高出力ピックアップと、実用性の高いネック形状を組み合わせた「コストパフォーマンスの高いメタルギター」という評価を確立している。",
          ],
        },
        {
          heading: "代表製品ラインナップ",
        ...
        },
        {
          heading: "お金の話",
          paragraphs: [
            "パーツメーカーから完成品ブランドへの転換に成功した数少ない事例。ESP/LTDやJacksonと競合する価格帯・ジャンルに位置しながら、独自の「価格の割に上質」という評価軸で差別化を図っている。",
          ],
        },
        {
          heading: "業界内でのポジション",
          paragraphs: [
            "ESP/LTD、Jacksonと並ぶメタル系ブランドの一角。特にミドルクラス価格帯でのコストパフォーマンスの良さで支持を集めている。",
          ],
        },
        {
          heading: "豆知識",
          paragraphs: [
            "元々はパーツ専業だったという成り立ちから、現在も自社製ハードウェア(ブリッジ、ペグ等)の設計力に定評がある。",
          ],
        },
      ],
      quiz: [
      ...
      sections: [
        {
          heading: "会社の正体・沿革",
          paragraphs: [
            "1947年、アメリカでNathan Danielが設立。当初から一貫して「低コストで独特の音を出す」ことを追求したブランドで、Sears百貨店のプライベートブランド「Silvertone」向けにもOEM供給していたことで知られる(アンプ内蔵ケースにギターを収納できる伝説的なセットモデルも手がけた)。",
            "1969年に一度生産を終了したが、後にブランドが復活し現在まで独特なポジションを保ち続けている。",
          ],
        },
        {
          heading: "音の特徴",
          paragraphs: [
            "ボディにマソナイト(木質繊維板)を使うなど、当時としては異例の低コスト構造を採用。ピックアップは実際に口紅容器の金属ケースを流用して作られたとされる「リップスティックピックアップ」で、独特の細く粒立った音を生み出す。",
          ],
        },
        {
          heading: "代表製品ラインナップ",
        ...
        },
        {
          heading: "お金の話",
          paragraphs: [
            "「安く作る」ことそのものを個性・音楽的価値に転換した稀有な成功例とされる。高級ブランドとは真逆の方向性でありながら、独特の音を求めるレコーディングエンジニアやプロデューサーに根強く支持されている。",
          ],
        },
        {
          heading: "業界内でのポジション",
          paragraphs: [
            "Fender/Gibsonの「正統派」路線とは全く異なる、「変わり種・個性派」ギターというジャンルの代表格。実験的なレコーディングで「もう一味違う音」が欲しい時の選択肢として扱われることが多い。",
          ],
        },
        {
          heading: "豆知識",
          paragraphs: [
            "「リップスティックピックアップ」という名称は、実際に口紅の金属チューブ容器を転用して作られたという逸話に由来しており、コスト削減の工夫がそのまま製品の個性・伝説になった珍しい例。",
          ],
        },
      ],
      quiz: [
      ...
      sections: [
        {
          heading: "会社の正体・沿革",
          paragraphs: [
            "1997年、Fender Custom ShopのマスタービルダーだったJohn Suhrが独立して設立。ブティック(少量高品質生産)ギターブランドの代表格として、精密な製造技術を武器に急成長した。",
          ],
        },
        {
          heading: "音の特徴",
          paragraphs: [
            "Fender/PRS系の伝統的な設計をベースにしながら、フレットの擦り合わせ精度やネックの品質管理など「工作精度」そのものを競うレベルまで突き詰めている。ピックアップも自社開発・製造しており、素材から一貫した音作りを行っている。",
          ],
        },
        {
          heading: "代表製品ラインナップ",
        ...
        },
        {
          heading: "お金の話",
          paragraphs: [
            "PRSと似た「ブティック/ハイエンド」路線だが、より少量生産・受注生産に近い体制を維持しており、価格帯もさらに上位に位置することが多い。セッションミュージシャン・プロツアーミュージシャンからの支持が特に厚い。",
          ],
        },
        {
          heading: "業界内でのポジション",
          paragraphs: [
            "Tom Anderson、Fodera(ベース)などと並ぶ「ブティックビルダー」市場の代表格。量産ブランドとは異なる、少量生産ならではの精密さで評価されている。",
          ],
        },
        {
          heading: "豆知識",
          paragraphs: [
            "創業者John Suhr自身が現在も製品開発・回路設計に深く関わっており、「職人の名前がそのままブランド名」という、ブティックギター文化を象徴する成り立ちを持つ。",
          ],
        },
      ],
      quiz: [
      ...
      sections: [
        {
          heading: "会社の正体・沿革",
          paragraphs: [
            "アメリカ・ニューヨークのリペア/カスタムビルダーRoger Sadowskyが1980年代に設立。数多くのトップセッション/ツアーベーシストの機材調整を手がけてきたリペアマンとしてのキャリアが土台になっている。",
            "近年は日本の工場と提携し、より手頃な「Metroライン」を展開する一方、NYC本店では引き続き最高級のハンドメイドモデルを製作するという二段構えの体制を取っている。",
          ],
        },
        {
          heading: "音の特徴",
          paragraphs: [
            "Fender Jazz Bass的な伝統的設計をベースにしつつ、自社開発の「Sadowskyプリアンプ」(外付け/内蔵両対応のアクティブEQ回路)による上質なローエンドとハイの伸びが特徴。このプリアンプ単体が他社製ベースへの後付けパーツとしても広く流通している。",
          ],
        },
        {
          heading: "代表製品ラインナップ",
        ...
        },
        {
          heading: "お金の話",
          paragraphs: [
            "単体製品としてのベース販売だけでなく、「Sadowskyプリアンプ」というパーツ単体のビジネスが確立している点が特徴的。他ブランドのベースにこの回路を組み込むというカスタム需要も根強い。",
          ],
        },
        {
          heading: "業界内でのポジション",
          paragraphs: [
            "Fodera、Kenn Smithと並ぶニューヨーク発のハイエンドベースビルダーの一角。特にセッションミュージシャンからの信頼が厚く、「縁の下の力持ち」的なブランドイメージを持つ。",
          ],
        },
        {
          heading: "豆知識",
          paragraphs: [
            "Marcus Millerは自身のシグネチャーベース(Fender)を持つ以前、長年Sadowsky製のJazz Bass系モデルをレコーディング/ライブで愛用していたことで知られる。",
          ],
        },
      ],
      quiz: [
      ...
      sections: [
        {
          heading: "会社の正体・沿革",
          paragraphs: [
            "1983年、ニューヨークでVinnie FoderaとJoey Lauricellaが設立。完全受注のハンドメイド生産にこだわり、ベース業界でも屈指の高価格帯ブランドとして知られる。",
            "ベーシストAnthony Jacksonが提唱した「コントラバスギター」(通常の4弦ベースより広い音域を持つ6弦ベースのコンセプト)は、Foderaとの協業によって初めて具現化されたとされる。",
          ],
        },
        {
          heading: "音の特徴",
          paragraphs: [
            "極めて精密な木材選定・加工と、手作業による調整によって、量産品では出しにくい繊細なニュアンス表現力を実現している。スラップからフィンガーピッキングまで幅広い奏法に対応する懐の深さも特徴。",
          ],
        },
        {
          heading: "代表製品ラインナップ",
        ...
        },
        {
          heading: "お金の話",
          paragraphs: [
            "1本あたりの価格は数百万円規模に達することもあり、完全受注生産のため納期も長期化しやすい。「ベース界のロールスロイス」と称されるほどの価格帯・希少性を保っている。",
          ],
        },
        {
          heading: "業界内でのポジション",
          paragraphs: [
            "Ken Smith、Sadowskyと並ぶニューヨーク発ハイエンドベースの頂点として扱われる。特にフュージョン/ジャズ系の超絶技巧ベーシストからの支持が厚い。",
          ],
        },
        {
          heading: "豆知識",
          paragraphs: [
            "Victor Wooten(ベーシスト)のシグネチャーモデルは、Foderaのハイエンドブランドイメージを象徴する存在として広く知られている。",
          ],
        },
      ],
      quiz: [
      ...
      sections: [
        {
          heading: "会社の正体・沿革",
          paragraphs: [
            "1976年、ニューヨークでStuart Spectorが設立。看板モデル「NSシリーズ」(New Sound)は、人間工学的な曲線ボディを持つ独特のデザインで、発表当初から大きな話題を呼んだ。",
          ],
        },
        {
          heading: "音の特徴",
        ...
        },
        {
          heading: "お金の話",
          paragraphs: [
            "設立以来複数回オーナーが変わっているが、独特なボディデザインというブランド資産により、常に一定のファン層を維持し続けてきた。",
          ],
        },
        {
          heading: "業界内でのポジション",
          paragraphs: [
            "Warwick同様「見た目も音も個性的」なベースの代表格。ロック/メタル系ベーシストからの支持が厚い。",
          ],
        },
        {
          heading: "豆知識",
          paragraphs: [
            "NSシリーズの曲線ボディデザインは、後にヘッドレスベースなど他社の人間工学的設計にも影響を与えたとされる。",
          ],
        },
      ],
      quiz: [
      ...
      sections: [
        {
          heading: "会社の正体・沿革",
          paragraphs: [
            "1969年、アメリカ・サンフランシスコで設立。ロックバンドGrateful Deadの音響機材制作チームと近い関係にあり、ベーシストPhil Leshとの協業を通じて、当時まだ珍しかった「ベース本体に電池駆動のアクティブ回路を搭載する」という設計を早くから実用化した。",
          ],
        },
        {
          heading: "音の特徴",
          paragraphs: [
            "エキゾチックウッドの複雑な積層(ラミネート構造)ボディと、独自のアクティブ電子回路により、非常に情報量の多い、広いダイナミックレンジを持つサウンドが特徴。当時としては「ハイファイすぎる」とすら評された先進性を持っていた。",
          ],
        },
        {
          heading: "代表製品ラインナップ",
        ...
        },
        {
          heading: "お金の話",
          paragraphs: [
            "「ブティックベース」というジャンルそのものの生みの親とされ、後発のFodera、Ken Smithらのハイエンドベースビルダーの先駆的存在として位置づけられている。",
          ],
        },
        {
          heading: "業界内でのポジション",
          paragraphs: [
            "「アクティブベースの元祖」として、現在のあらゆるアクティブベースメーカー(Music Man、Warwick等)の源流に位置づけられる歴史的な存在。",
          ],
        },
        {
          heading: "豆知識",
          paragraphs: [
            "Grateful DeadのPhil Leshは、自身の要望を反映させる形でAlembicの黎明期の開発に深く関与しており、「顧客兼共同開発者」という関係性は楽器業界でも珍しい成り立ちとされる。",
          ],
        },
      ],
      quiz: [
